...
<Steps>
  ...
  Defines the purpose, features, functionality, and behavior of a product to be developed or launched
  ...
  * **Acceptance criteria**: A set of measurable and testable conditions 
  ...
  <Accordion title="Expected Schedule">
  <Steps>
  <Step title="Day 1, Team Bonding & Feasibility">
  </Step>
  <Step title="Day 2, Feature #1">
  </Step>
  <Step title="Day 3, Feature #2">
  </Step>
  <Step title="Day 4, Feature #3">
  </Step>
  <Step title="Day 5, Video + Retrospective & Review">
  </Step>
  </Steps>
  </Accordion>
  ...
  **Tools**: Microsoft Teams, Loop, Word & PowerPoint
  </Step>
</Steps>
